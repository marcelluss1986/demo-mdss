...
import com.mdss.demo.entities.Payment;
...
import com.mdss.demo.repositories.OrderItemRepository;
import com.mdss.demo.repositories.OrderRepository;
import com.mdss.demo.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Payment pay1 = new Payment(null, Instant.parse("2022-05-22T16:00:00Z"), o1);
		o1.setPayment(pay1);
